+(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "BookStore"; // Prefix string to be prepended to the cart's name in the session storage
		...
		displayUserDetails: function() {
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-name" ) == null ) {
					...
					var pin = this.storage.getItem( "billing-pin" );
					...
					var sPin = this.storage.getItem( "shipping-pin" );
		...
		_saveFormData: function( form ) {
			...
			$visibleSet.each(function() {
				...
				if( $set.is( "#fieldset-billing" ) ) {
					...
					self.storage.setItem( "billing-pin", pin );
					...
					self.storage.setItem( "shipping-pin", sPin );
